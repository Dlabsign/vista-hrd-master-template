...
class GeneralCompetenciesController extends Controller
{
    ...
    /**
     * Lists all GeneralCompetencies models.
     *
     * @return string
     */
    ...
    /**
     * Displays a single GeneralCompetencies model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Creates a new GeneralCompetencies model.
    ...
    /**
     * Updates an existing GeneralCompetencies model.
    ...
    /**
     * Deletes an existing GeneralCompetencies model.
    ...
    /**
     * Finds the GeneralCompetencies model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return GeneralCompetencies the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
