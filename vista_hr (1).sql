...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Jun 2025 pada 22.49
...
CREATE TABLE `general_competencies` (
  `id` int(11) NOT NULL,
  `core_id` int(11) NOT NULL COMMENT 'Terhubung ke master_performance_management	',
  `area_id` int(11) NOT NULL COMMENT 'Terhubung ke master_performance_management	',
...
INSERT INTO `general_competencies` (`id`, `core_id`, `area_id`, `definition`, `objectives`, `created_at`, `flag`) VALUES
(11, 10, 10, '10', 'Objective test', '2025-06-20 19:09:38', 1),
(12, 11, 11, '11', 'ISISIIS', '2025-06-22 16:50:21', 1),
(13, 10, 10, '10', 'Test', '2025-06-20 17:26:30', NULL),
(14, 12, 10, '10', 'A', '2025-06-20 19:09:03', 0);
...
CREATE TABLE `leadership_competencies` (
  `id` int(11) NOT NULL,
  `core_id` int(11) DEFAULT NULL COMMENT 'Terhubung ke master_performance_management\r\n',
  `area_id` int(11) DEFAULT NULL COMMENT 'Terhubung ke master_performance_management	',
...
INSERT INTO `leadership_competencies` (`id`, `core_id`, `area_id`, `definition`, `objectives`, `created_at`, `flag`) VALUES
(5, 10, 10, '10', 'Obejctive Test DNIEL OBJ', '2025-06-16 18:46:15', 1),
(6, 10, 10, '10', 'DANIEL TESTING\r\nasASD', '2025-06-20 17:32:32', 0),
(7, 10, 10, '10', 'flag = 1\r\n', '2025-06-20 19:03:03', NULL),
(8, 10, 10, '10', 'ASDASDD', '2025-06-20 19:04:07', NULL),
(10, 10, 10, '10', 'Ini testing flag', '2025-06-20 14:07:50', 0);
...
INSERT INTO `master_performance_management` (`id`, `core`, `key_val`, `definition`, `created_at`, `flag`, `nominal`) VALUES
(10, 'Core Test', 'Key Test', 'Definition Test', '2025-06-20 21:45:50', 1, NULL),
(11, 'Daniel Testing', 'Daniel Testing', 'Daniel Testing', '2025-06-19 09:18:30', 0, NULL),
(12, 'Vos', 'VOS', 'VOS Enrollment (by Pax)', '2025-06-19 09:39:40', 0, NULL),
(13, 'VOS', 'VOS', 'VOS Leaving', '2025-06-19 09:44:27', 0, NULL),
(14, 'D', 'D', 'D', '2025-06-20 21:42:56', 0, NULL),
(15, 'Testing', 'Testing', 'Testing', '2025-06-20 21:46:11', 1, NULL),
(16, 'VOS', 'VOS Enrollment (by Pax)', 'Analytical Thinking', '2025-06-21 22:52:04', 1, NULL);
...
INSERT INTO `master_template` (`id`, `position_id`, `area_id`, `technical`, `general`, `weight`, `key_result`, `unit`, `template_type`, `leadership`, `created_at`, `flag`) VALUES
(125, 16, 11, 0, 1, 2, 'Daniel Testing', NULL, NULL, 0, '2025-06-22 13:26:44', 1),
(126, 16, 12, 0, 0, 5000, 'VOS', NULL, NULL, 1, '2025-06-22 13:29:29', 1),
(127, 16, 12, 0, 1, 123, 'VOS', NULL, NULL, 0, '2025-06-22 13:29:39', 1),
(128, 16, 16, 0, 0, 653, 'VOS Enrollment (by Pax)', 'Nominal', 'Probation', 0, '2025-06-22 13:31:07', 1),
(129, 23, 5, 0, 0, 2, '', NULL, NULL, 1, '2025-06-22 13:32:39', 1),
(130, 23, 11, 0, 1, 8, 'Daniel Testing', NULL, NULL, 0, '2025-06-22 13:33:17', 1),
(131, 23, 5, 0, 0, 88888, '', NULL, NULL, 1, '2025-06-22 13:40:03', 1),
(132, 23, 12, 0, 1, 123, 'VOS', NULL, NULL, 0, '2025-06-22 13:40:15', 1),
(133, 14, 11, 0, 1, 5, 'Daniel Testing', NULL, NULL, 0, '2025-06-22 14:15:39', 1),
(134, 14, 15, 0, 0, 9, 'Testing', 'Nominal', 'Probation', 0, '2025-06-22 14:16:06', 1),
(135, 14, 5, 0, 0, 99999, '', NULL, NULL, 1, '2025-06-22 14:16:18', 1),
(136, 14, 15, 1, 0, 80, 'Testing', 'Nominal', 'PKWT 2', 0, '2025-06-22 14:46:49', 1),
(137, 23, 5, 0, 0, 50, '', NULL, NULL, 1, '2025-06-22 15:16:54', 1),
(138, 23, 5, 0, 0, 50, '', NULL, NULL, 1, '2025-06-22 15:16:55', 1);
...
INSERT INTO `target_performance` (`id`, `area_id`, `unit`, `created_at`, `flag`, `key_result`) VALUES
(4, 10, 'Percentage', '2025-06-16 18:46:39', 0, 0),
(5, 11, 'Nominal', '2025-06-19 09:37:05', 0, 0),
(6, 12, 'Percentage', '2025-06-19 09:50:08', 0, 0),
(7, 10, 'Nominal', '2025-06-21 15:21:10', 0, 0),
(8, 16, 'Nominal', '2025-06-21 15:38:40', 1, 0),
(9, 15, 'Percentage', '2025-06-21 15:44:01', 1, 0),
(10, 0, '', '2025-06-21 17:47:21', 1, 0),
(11, NULL, 'Percentage', '2025-06-21 17:47:25', 1, 0),
(12, 10, 'Nominal', '2025-06-21 17:48:30', 1, 0);
...
INSERT INTO `work_performance` (`id`, `area_id`, `position_id`, `department_id`, `definition`, `objectives`, `created_at`, `flag`) VALUES
(3, 10, 0, 0, '10', 'Objective test\r\n', '2025-06-16 18:46:51', 1),
(4, 10, 0, 0, '12', 'as', '2025-06-20 18:53:39', 0),
(6, 10, 0, 0, '10', 'WORK Flag = 1', '2025-06-20 14:11:15', 1);
